...
public class PerpustakaanApp {
    ...
    public static void lihatRiwayatPeminjaman(int id){
        int size = peminjamanController.showDataByPeminjaman(id).size();
        for (int i =0; i < size ; i++){
           String status = !peminjamanController.showDataByPeminjaman(id).get(i).isStatusPeminjaman() ? "Masih dipinjam ":"Telah Kembali ";
           System.out.println((i+1)+". "+peminjamanController.showDataByPeminjaman(id).get(i).getIdPeminjaman()+" "+
                peminjamanController.showDataByPeminjaman(id).get(i).getBuku().getJudul()+" "+
                peminjamanController.showDataByPeminjaman(id).get(i).getTglPeminjaman()+" "+
                peminjamanController.showDataByPeminjaman(id).get(i).getTglPengembalian()+" "+
                status
           );
        }
    } 
    ...
    public static void pinjamBuku(int id){
        ...
        AnggotaEntity anggota = anggotaController.getDataId(id);
    ...
    public static void dataPenggunaById(int id){
        System.out.println(
                anggotaController.getDataId(id).getNama()+ " " +
                anggotaController.getDataId(id).getPassword()+ " " +
                anggotaController.getDataId(id).getNoTelp()+ " " +
                anggotaController.getDataId(id).getAlamat()
        );
    }
}